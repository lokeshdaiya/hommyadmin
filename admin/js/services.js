 ...
 */
angular.module('hommyAdmin.services',[])
    ...
    .service('kitchenService',function(httpService,$rootScope){
         ...
         kitchenService.getKitchens = function (callback) {
             var config = {
                 headers: {
                     'authorization': $rootScope.authKey,
                     'Accept': 'application/json'
             ...
             var kitchenGetApiUrl = $rootScope.baseApiUrl + "/kitchens";
             httpService.GetData(kitchenGetApiUrl, config, function (response) {
                 callback(response);
             });
         }
    ...
    .factory('userService',function(httpService,$rootScope,$localstorage,jwtHelper){
         ...
         userService.getAllUsers = function (callback) {
             var userApiUrl = $rootScope.baseApiUrl + "/users";
             var config = {
                 headers: {
                     'authorization': $rootScope.authKey,
                     'Accept': 'application/json'
   ...
   .service('locationService',function(httpService,$filter){
    ...
    .service('orderService',function(httpService,$rootScope){
         ...
         orderService.addOrder=function(data,callback){
            ...
            var orderApiUrl=$rootScope.baseApiUrl+"/orders";   
         ...
         orderService.updateOrder=function(orderId,data,callback){
             ...
             var orderApiUrl=$rootScope.baseApiUrl+"/orders/"+orderId;   
             httpService.PutData(orderApiUrl, data, headers, function (response) {
                 callback(response);
             })
         }
